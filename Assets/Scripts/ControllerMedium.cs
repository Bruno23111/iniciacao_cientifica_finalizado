...
public class ControllerMedium : MonoBehaviour
{
    [SerializeField]
    ...
    void Update()
    {
        scoreTextMedium.text = "Score: " + Mathf.Round(ScoreManager.scoreCountMedium);
        ScoreManager.AtualizarMaiorScore(ScoreManager.scoreCountMedium);
        waveText.text = "Fase : " + Mathf.Round(waveController.waveMedium) + " Concluída";
        checkIfPlayerLose();
    ...
    IEnumerator CheckIfThePuzzleMatch()
    {
        ...
        if (firstGuessPuzzle == secondGuessPuzzle)
        {
            ...
            ScoreManager.scoreCountMedium += 65;
        ...
        else
        {
            ...
            if (ScoreManager.scoreCountMedium != 0)
            {
                ScoreManager.scoreCountMedium -= 10;
            }
